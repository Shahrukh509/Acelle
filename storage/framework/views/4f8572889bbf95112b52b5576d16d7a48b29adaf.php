<li class="nav-item dropdown">
	...
	>
		...
		<span class="leftbar-item"><?php echo e(trans('messages.activities'), false); ?></span>
	</a>
</li>
...
<script>
	...
	$(function() {
		$('.activities-menu-item').on('click', function() {
			...
			if(!sidebar.showed()) {
				sidebar.load({
					url: '<?php echo e(action('AccountController@activity'), false); ?>'
				});
			} else {
				sidebar.hide();
			}
...
</script><?php /**PATH C:\xampp\htdocs\acellemail\resources\views/layouts/core/_top_activity_log.blade.php ENDPATH**/ ?>
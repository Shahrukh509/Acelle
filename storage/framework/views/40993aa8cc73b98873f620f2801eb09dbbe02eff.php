<div class="mb-4">
    <label class="dark-mode-select me-3 xtooltip" title="<?php echo e(trans('messages.theme_mode.dark.intro'), false); ?>">
        <input style="display:none" type="radio" name="theme_mode" value="dark" <?php echo e($theme_mode == 'dark' ? 'checked' : '', false); ?> class="styled mr-2" />
    ...
    <label class="dark-mode-select me-3 xtooltip" title="<?php echo e(trans('messages.theme_mode.light.intro'), false); ?>">
        <input style="display:none" type="radio" name="theme_mode" value="light" <?php echo e($theme_mode == 'light' ? 'checked' : '', false); ?> class="styled mr-2"  />
    ...
    <label class="dark-mode-select xtooltip" title="<?php echo e(trans('messages.theme_mode.auto.intro'), false); ?>">
        <input style="display:none" type="radio" name="theme_mode" value="auto" <?php echo e($theme_mode == 'auto' ? 'checked' : '', false); ?> class="styled mr-2"  />
...
</div><?php /**PATH C:\xampp\htdocs\acellemail\resources\views/layouts/core/_theme_mode_control.blade.php ENDPATH**/ ?>